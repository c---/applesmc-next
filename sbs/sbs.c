...
static LIST_HEAD(acpi_sbs_list);
...
EXPORT_SYMBOL_GPL(sbs_hook_register);
 ...
 */
static void battery_hook_add_battery(struct acpi_sbs *sbs, int id)
{
...
static void battery_hook_remove_battery(struct acpi_sbs *sbs, int id)
{
...
static int acpi_battery_add(struct acpi_sbs *sbs, int id)
{
	...
	battery_hook_add_battery(sbs, id);
      end:
...
static void acpi_battery_remove(struct acpi_sbs *sbs, int id)
{
	...
	battery_hook_remove_battery(sbs, id);
